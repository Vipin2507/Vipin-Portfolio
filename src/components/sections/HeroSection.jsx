    ...
    <div className="max-w-7xl mx-auto w-full z-10 mt-20">
        ...
        <div className="block lg:hidden">
            ...
            >
                ...
                } mb-8 max-2-xl mx-auto font-light leading-relaxed`}
                >
                ...
                >
                    {[
                        {icon:FiGithub, href:"https://github.com/Vipin2507",Target:"_blank"},
                        {icon:FiLinkedin, href:"https://www.linkedin.com/in/vipintomar2507/",Target:"_blank"},
                        {icon:Mail, href:"mailto:vipintomar2507@gmail.com"},
                    ].map((social, index)=> (
                        <motion.a
                        key={index}
                        href={social.href}
  ...
  <span className={isDarkMode ? "text-gray-600" : "text-gray-500"}>MongoDB</span>
        ...
        <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            >
                ...
                >
                    {[
                        {icon:FiGithub, href:"https://github.com/Vipin2507",target: "_blank", rel: "noopener noreferrer"},
                        {icon:FiLinkedin, href:"https://www.linkedin.com/in/vipintomar2507/",target: "_blank", rel: "noopener noreferrer"},
                        {icon:Mail, href:"mailto:vipintomar2507@gmail.com",target: "_blank", rel: "noopener noreferrer"},
                    ].map((social,index)=>(
                        <motion.a
                        key={index}
                        href={social.href}
